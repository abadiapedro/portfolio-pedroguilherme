...
export const About = () => {
  ...
  return (
    <section
      id="about"
      className="w-full flex flex-col justify-start mt-8 mb-10 items-center px-4 md:px-8 py-4 bg-white text-black dark:bg-gray-900 dark:text-white transition-colors"
    >
      <motion.div
